        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="khenchela - la cité bouzid" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Address Line 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="Near Al Tawbah Mosque" type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon">+213</span>
                        </div>
